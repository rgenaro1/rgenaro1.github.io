...
# Quitar la clase que esconde los botones en VisionMeasure (movil)
# Mantenemos ArUco solo en escritorio.
markers = [
    (
...
js_add = '''document.getElementById('btnResetCorners').addEventListener('click', () => {'''
undo = '''
...
t = t.replace("<title>Dantix Leather Vision v206</title>", "<title>Dantix Leather Vision v206-lab</title>", 1)
